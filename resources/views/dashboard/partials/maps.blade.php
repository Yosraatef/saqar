<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBsGwp19k_0lr31Hnyos-OPLdJ9FwTO6k4&libraries=geometry">
</script>
...
/*************************/
    ...
    <style>
        ...
        <div class="form-group">
            <label for="computer">العنوان  على الخريطه</label>
            ...
            <input type="hidden" id="lon" name="long"><br>
            {{-- <center> --}}
            <!-- MAP HOLDER -->
